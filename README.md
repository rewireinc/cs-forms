...
- `au-consent-cs.html` - App Unity Consent用フォーム
- `au-subscription-cs.html` - App Unity Subscription用フォーム
### 3. フォームの編集
...
- App Unity Consent: https://rewireinc.github.io/cs-forms/au-consent-cs.html
- App Unity Subscription: https://rewireinc.github.io/cs-forms/au-subscription-cs.html
